...
select first_name,hire_date from employees where hire_date between '1995-01-1' and '1998-01-01';
select job_title , max_salary  from  jobs where max_salary<5000;
select lower(email) from employees ;
select first_name,hire_date   from     employees where hire_date like '1995%';
